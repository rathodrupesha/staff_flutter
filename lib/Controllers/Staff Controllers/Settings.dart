...
import 'package:hamrostay/Controllers/Staff%20Controllers/ChangePassword.dart';
import 'package:hamrostay/Controllers/Staff%20Controllers/FAQs.dart';
import 'package:hamrostay/Controllers/Staff%20Controllers/Login.dart';
import 'package:hamrostay/Controllers/Staff%20Controllers/TermsOfUse.dart';
...
import 'package:hamrostay/localization/app_model.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Container(
              ...
              child: DropdownButton<String>(
                ...
                onChanged: (String? newValue) {
                  ...
                  MyPrefs.putBoolean(Keys.IS_ENGLISH,
                      Constants.isEnglishLanguage);
                },
                items: <String>['English', 'Chinese']
                    .map<DropdownMenuItem<String>>(
                      ...
                      return DropdownMenuItem<String>(
                        value: value,
                        child: Text(value,style: TextStyle(color: Colors.white,fontFamily: "Inter"),),
                      );
                    }).toList(),
              ),
            )
            ...
            context, 'Menu', 'assets/images/img_close.png', Colors.white, () {
          Navigator.of(context).pop();
          ...
          child: ListView(
            children: [
              Column(
                ...
                children: [
                  WidgetUtils().buttonSettingsWidget(context, Translations.of(context).strChangePassword,
                          () {
                        WidgetUtils().push(
                            context,
                  ...
                  WidgetUtils().buttonSettingsWidget(context, Translations.of(context).strPrivacyPolicy,
                      () {
                    WidgetUtils().push(
                        context,
                        () => TermsOfUse(
                              strTitle: Translations.of(context).strPrivacyPolicy,strType: "privacy"
                            ));
                  }, 'assets/images/img_privacy_policy.png'),
                  WidgetUtils().sizeBoxHeight(12),
                  WidgetUtils().buttonSettingsWidget(context, Translations.of(context).strTermsOfUse,
                      () {
                    WidgetUtils().push(
                        context,
                        () => TermsOfUse(
                              strTitle: Translations.of(context).strTermsOfUse ,strType: "terms",
                            ));
                  }, 'assets/images/ic_terms_of_use.png'),
                  WidgetUtils().sizeBoxHeight(12),
                  WidgetUtils().buttonSettingsWidget(context, Translations.of(context).strAboutUs, () {
                    WidgetUtils().push(
                        context,
                        () => TermsOfUse(
                              strTitle: Translations.of(context).strAboutUs ,strType: "aboutAs",
                            ));
                  }, 'assets/images/ic_about_us.png'),
                  WidgetUtils().sizeBoxHeight(12),
                  WidgetUtils().buttonSettingsWidget(context, Translations.of(context).strFAQs, () {
                    WidgetUtils().push(
                        context,
                        () => FAQs(
                  ...
                  WidgetUtils().sizeBoxHeight(12),
                  WidgetUtils().buttonSettingsWidget(context, Translations.of(context).strSignOut, () {
                    wsLogout();
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Container(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular((SizeConfig.screenHeight * 0.28) / 2),
              ...
              WidgetUtils().simpleTextViewWithGivenFontSize(
                  (userData.firstName != null) ? '${userData.firstName! + " " + userData.lastName!}' : "",
                  getProportionalScreenWidth(16),
                  Constants.blueColor,
                  "Inter",
                  FontWeight.w400),
